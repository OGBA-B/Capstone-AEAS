...
class Adafruit_PN532{
 public:
  ...
  // ISO14443A functions
  uint32_t readPassiveTargetID(uint8_t cardbaudrate, uint8_t * uid, uint8_t * uidLength, uint16_t timeout = 0); //timeout 0 means no timeout - will block forever.
  uint32_t readPassiveTargetID1(uint8_t cardbaudrate, uint16_t timeout = 0);
